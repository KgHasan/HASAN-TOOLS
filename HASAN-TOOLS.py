...
'---'       `--`---'                `--`---'            '---'    
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1m×͜× Ꮋᴀꜱᴀɴ ™
\x1b[93;1m Facebook       \x1b[92;1m=>        \x1b[93;1mhttps://www.facebook.com/ami.ajo.single.prem.kormo
\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1mKgHasan
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [Hasa N] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [Hasa N-CP] %s|%s        '%(b,idf,pw))
